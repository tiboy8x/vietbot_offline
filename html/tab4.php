...
$auth_users = array(
    ...
    'pi' => '$2y$10$KwIcCvRrNvSTLb0GQUiDPu5PPBwJBwOwogrV/.luXtI3ztISVBtUi', //vietbot
...
$root_path = '/home/pi/vietbot_offline/src/';
...
$external = array(
    ...
    'js-jquery' => '<script src="assets/js/jquery-3.6.4.min.js"></script>',
...
defined('FM_SELF_TUYEN') || define('FM_SELF_TUYEN', ($is_https ? 'https' : 'http') . '://' . $http_host . "/index.php");
        ...
        <div class="card mb-2 <?php echo fm_get_theme(); ?>">
            ...
            <div class="card-body">
                <form id="js-settings-form" action="" method="post" data-type="ajax" onsubmit="return save_settings(this)">
                    ...
                    <div class="mb-3 row">
                        <div class="col-sm-10">
						<center><a onClick="window.location.reload()"><p id="reloadvt"></p></a></center>
...
<script>
    ...
    function save_settings($this) {
        ...
        $.ajax({
            ...
            success: function (data) {if(data) {document.getElementById("reloadvt").innerHTML = "Thành Công, Nhấn Vào Dòng Chữ Này Để Tải Lại";}}
        }); return false;
    }
